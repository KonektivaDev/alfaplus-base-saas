...
const WelcomeVerificationEmail = (props: WelcomeVerificationEmailProps) => {
  ...
  return (
    <Html lang="en" dir="ltr">
      <Tailwind>
        <Head />
        <Preview>Complete your account setup — verify your email</Preview>
          ...
          <Container className="mx-auto max-w-[600px] rounded-[8px] bg-white px-[32px] py-[40px]">
            <Section>
              ...
              <Text className="mb-[24px] text-[16px] leading-[24px] text-gray-700">
                An administrator has created an account for you in Alfa+. To
                finish setup and access the system, please verify your email
